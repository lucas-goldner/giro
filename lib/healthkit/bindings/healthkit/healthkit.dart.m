...
typedef void  (^ListenerBlock29)(HKSampleQuery* , NSArray* , NSError* );
ListenerBlock29 wrapListenerBlock_ObjCBlock_ffiVoid_HKSampleQuery_NSArray_NSError(ListenerBlock29 block) NS_RETURNS_RETAINED {
  return ^void(HKSampleQuery* arg0, NSArray* arg1, NSError* arg2) {
    block(objc_retain(arg0), objc_retain(arg1), objc_retain(arg2));
  };
}
